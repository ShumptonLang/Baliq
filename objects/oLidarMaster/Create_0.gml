...
drawFunc = function(){
	...
	if lastHistTotal != (hist){
		...
		draw_sprite_part_ext(spr_start,0,ShipMaster.posx-oSLMaster.view_width/2,ShipMaster.posy-oSLMaster.view_height/2,oSLMaster.view_width,oSLMaster.view_height,0,0,1,1,c_green,1)
