...
if ControllerService.shipStatus.eyeCast.camREnabled{
	draw_sprite_ext(sViewport,1,0,0,1,1,0,c_white,0.5)
	...
	if surface_exists(dSurf) {
		...
		draw_sprite_general(mapy,0,posCamLx -surface_get_width(dSurf)/2,posCamLy-surface_get_height(dSurf)/2,surface_get_width(dSurf),surface_get_height(dSurf),0,0,1,1,0,c_white,c_white,c_white,c_white,1)
		shader_reset()
		surface_reset_target()


		draw_surface_ext(dSurf,720+80,540,0.6,0.6,-90,c_white,1)
	}
}